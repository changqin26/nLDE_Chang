...
def create_plan(query, eddies, source):
    ...
    operators_sym.update({id_operator: True}) #This line of code updates the operators_sym dictionary with a key-value pair where the key is the id_operator and the value is set to True, indicating that the operator with that ID is symmetric.
