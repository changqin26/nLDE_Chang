...
def get_options():
    ...
    parser.add_argument("-p", "--policy",
                        ...
                        choices=["NoPolicy", "Ticket", "Random","Productivity", "IncludingNLJ"],
                        default="NoPolicy")
    ...
    return args.server, args.file, args.query, args.eddies, args.timeout, args.results, args.policy, False#args.explain
